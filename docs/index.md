# Instalação e Configuração de Servidores - IFRN/SPP

Material de aula da disciplina de **Instalação e Configuração de Servidores (ICS)** do Curso Técnico Integrado em Informática para Internet, apresentada no [IFRN campus São Paulo do Potengi](https://portal.ifrn.edu.br/campus/sao-paulo-do-potengi/) pelo professor [Diego Cirilo](https://github.com/dvcirilo-ifrn).
